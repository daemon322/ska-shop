  ...
  return (
    <div className="relative flex flex-col transition-all duration-300 shadow-lg w-72 bg-gradient-to-br from-white to-gray-100 dark:from-purple-800 dark:to-red-700 rounded-xl group hover:shadow-2xl CardProdcut">
      ...
      {!showReviews ? (
        <>
          {/* Imagen del producto */}
          <div className="relative w-full h-48 mb-4" onClick={handleCardClick}>
            <img
              src={product.image}
              alt={product.name}
          ...
          <div className="flex flex-col justify-around h-full px-4">
            ...
            <h2 className="relative overflow-hidden text-lg font-bold text-gray-800 dark:text-gray-200 overflow-ellipsis whitespace-nowrap groupes">
              {product.name}
              <span className="absolute bottom-0 w-full px-2 py-1 text-sm text-center text-white transition-opacity duration-300 transform -translate-x-1/2 translate-y-1 bg-gray-800 rounded opacity-0 cursor-not-allowed tooltip-text left-1/2 group-hover:opacity-100">
                {product.name}
              </span>
            </h2>
