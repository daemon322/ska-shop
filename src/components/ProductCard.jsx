...
const ProductCard = ({
  ...
  return (
    <div className="relative flex flex-col transition-all duration-300 shadow-lg w-72 bg-gradient-to-br from-white to-gray-100 dark:from-purple-800 dark:to-red-700 rounded-xl group hover:shadow-2xl h-[480px]">
      {offerTimeLeft && (
